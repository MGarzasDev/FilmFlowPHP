...
$sql = "SELECT * FROM peliculas WHERE titulo = 'Venom: Habrá Matanza'";
...
<a href="mainPage.php"><img src="./img/captura2-removebg-preview.png" alt="Logo" width="200px" /></a>
    ...
    <main>
        ...
        <iframe width="800" height="400" src="https://www.youtube.com/embed/hbfadtw-fjs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>        </div>
        <div class="movie_container">
        <img src="./img/accion7.jpg" alt="" width="200px">
