...
$sql = "SELECT * FROM peliculas WHERE titulo = 'Posesión infernal: El despertar'";
...
<a href="mainPage.php"><img src="./img/captura2-removebg-preview.png" alt="Logo" width="200px" /></a>
    ...
    <main>
        ...
        <iframe width="800" height="400" src="https://www.youtube.com/embed/keW_fKq187k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>        </div>
        <div class="movie_container">
        <img src="./img/terror3.jpg" alt="" width="200px">
